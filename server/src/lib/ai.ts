...
export async function generateTrainingPlan(
  ...
  //Normalize profile data // dont wanna pass a incorrent data to ai
  const normalizedProfile: UserProfile = {
    goal: profile.goal || "bulk",
    experience: profile.experience || "intermediate",
    days_per_week: Number(profile.days_per_week) || 4,
    session_length: Number(profile.session_length) || 60,
